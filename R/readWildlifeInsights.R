                                 ...
                                 image_file = NULL)
{
  ...
  # TODO: some WildlifeInsights datasets lack "placenames" column, leading to error here. 
  # Unclear why they are missing, since they are part of metadata standard. 
  # Reported as bug
  # maybe use deployment_id as a fallback?
