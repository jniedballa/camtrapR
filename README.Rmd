...
Many camtrapR functions read EXIF metadata from JPG images and videos via [**Exiftool**](https://exiftool.org/), a free and open-source tool by Phil Harvey (available for Windows, macOS, and Linux).

To make full use of camtrapR, you will need Exiftool on your system. See the installation instructions in [vignette 1](https://cran.r-project.org/web/packages/camtrapR/vignettes/camtrapr1.pdf) and the [Exiftool website](https://exiftool.org/).
