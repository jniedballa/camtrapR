...
To make full use of camtrapR, you will need Exiftool on your system. See the installation instructions in [vignette 1](https://CRAN.R-project.org/package=camtrapR/vignettes/camtrapr1.pdf) and the [Exiftool website](https://exiftool.org/).
