...
The latest vignettes, function reference and changelog can be found on the [REMOVED] or the [REMOVED]. Source code can be found on [REMOVED].
...
```{r eval = exiftool_present, message = FALSE, results = F}
...
```{r eval = exiftool_present, results = F}
 # raw image location
wd_images_raw <- system.file("pictures/raw_images", package = "camtrapR")   
...
```{r eval=exiftool_present, message=FALSE, results="hide"}
