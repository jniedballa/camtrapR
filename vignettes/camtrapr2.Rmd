...
Among these, we recommend digiKam because it is free and open-source software. Furthermore, if you wish to assign tags to videos and read them in camtrapR, tag the videos in digiKam. Extracting video tags only works if videos were tagged with digiKam.
...
wd_images_species_copy <- file.path(tempdir(), "sample_images_species_folders")
