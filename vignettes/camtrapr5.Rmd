...
```{r include=FALSE}
df_params = data.frame(Name = c("alpha", "beta", "0", "fixed", "ranef", "cont", "categ", "mean", "sigma", "tau"),
col2 = c("Submodel", "Submodel", "Intercept", "Effect type", "Effect type", "Covariate type", "Covariate type",
...
col3 = c("detection submodel", "occupancy submodel", "denotes the intercepts (alpha0, beta0)",
         "fixed effects (constant across species)", "random effects (of species and/or other categorical covariates)",
